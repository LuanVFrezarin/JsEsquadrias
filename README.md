...
3. Para fazer deploy, copie todos os arquivos para seu servidor web

## 📱 Seções do Site

- **Hero**: Introdução com call-to-action
- **Sobre**: História e diferenciais da empresa
- **Serviços**: 6 tipos principais de serviços
- **Portfólio**: Carrossel de 13 projetos realizados
- **Diferenciais**: 4 razões para escolher a empresa
- **Parceiros**: Marcas que a empresa trabalha
...
- **Google Fonts**: Tipografia profissional (Montserrat, Open Sans)
